...
import artifactOfChoice.patches.relics.BottledPlaceholderField;
import artifactOfChoice.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static artifactOfChoice.DefaultMod.makeRelicOutlinePath;
import static artifactOfChoice.DefaultMod.makeRelicPath;
