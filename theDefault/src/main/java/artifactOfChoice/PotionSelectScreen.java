...
public class PotionSelectScreen implements ScrollBarListener
{
    ...
    private AbstractPotion hoveredRelic = null;
    private AbstractPotion clickStartedRelic = null;
    private boolean grabbedScreen = false;
    private float grabStartY = 0.0F;
    private ScrollBar scrollBar;
    private Hitbox controllerRelicHb = null;

    private ArrayList<AbstractPotion> relics;
    private boolean show = false;
    private int selectCount = 1;
    private ArrayList<AbstractPotion> selectedRelics = new ArrayList<>();
    ...
    public ArrayList<AbstractPotion> getSelectedRelics()
    {
        ArrayList<AbstractPotion> ret = new ArrayList<>(selectedRelics);
        selectedRelics.clear();
        return ret;
    }

    public PotionSelectScreen()
    {
        scrollBar = new ScrollBar(this);
    }

    public void open(ArrayList<AbstractPotion> relics)
    {
    ...
    public void update()
    {
        ...
        if (hoveredRelic != null) {
            ...
            TipHelper.queuePowerTips(hoveredRelic.posX + hoveredRelic.hb.width *  .5f,hoveredRelic.posY,hoveredRelic.tips);
    ...
    private void renderList(SpriteBatch sb, ArrayList<AbstractPotion> list)
    {
        ...
        for (AbstractPotion r : list) {
            ...
            r.posX = (START_X + SPACE * col);
            r.posY = (scrollY - SPACE * row);
            r.render(sb);
            col += 1;
        }
    }
